...
ggsave("Figures/Fig5_historical_covariates.png", fig, width=8.4, height=9.6, dpi=400, bg=PAL$surface)
ggsave("Figures/Fig5_historical_covariates.pdf", fig, width=8.4, height=9.6, bg=PAL$surface)
cat("\nWritten: Figures/Fig5_historical_covariates.{png,pdf}\n")
