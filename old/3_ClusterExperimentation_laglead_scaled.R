...
#saveRDS(results_batch_scaled,"results_batch_lagleadscaled_nonDLS_BHNFWB.RDS")
...
batch_scaled2 <- readRDS(file.choose())
batch_scaled2 <- lapply(1:3, function(i) {
  do.call(cbind, lapply(batch_scaled2, function(x) x[[i]]))
})
