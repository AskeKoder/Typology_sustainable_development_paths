...
#Check which indicators break the scale and cap them
...
rownames(batch_scaled)[53:63] <- rownames(batch_scaled)[53:63][c(1,3,5,4,2,8,6,7,9,10,11)] 
...
#saveRDS(results_batch_scaled,"results_batch_scaled.RDS")
